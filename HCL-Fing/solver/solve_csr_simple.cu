...
__global__ void csr_L_solve_simple_kernel_coop(int* row_ctr,
    ...
    int local_group_end = start_row + WARP_PER_BLOCK * groupsPerWarp;
    ...
    while (off < nxt_row - 1) {
        ...
        if (!ready) {
            if (colidx >= start_row && colidx < local_group_end) { // esto identifica si la fila es procesada por el bloque
...
template __global__  void csr_L_solve_simple_kernel_coop<2>(int* row_ctr, const int* __restrict__ row_ptr, const int* __restrict__ col_idx, const VALUE_TYPE* __restrict__ val, const VALUE_TYPE* __restrict__ b, volatile VALUE_TYPE* x, volatile int* is_solved, int n);
template __global__  void csr_L_solve_simple_kernel_coop<4>(int* row_ctr, const int* __restrict__ row_ptr, const int* __restrict__ col_idx, const VALUE_TYPE* __restrict__ val, const VALUE_TYPE* __restrict__ b, volatile VALUE_TYPE* x, volatile int* is_solved, int n);
template __global__  void csr_L_solve_simple_kernel_coop<8>(int* row_ctr, const int* __restrict__ row_ptr, const int* __restrict__ col_idx, const VALUE_TYPE* __restrict__ val, const VALUE_TYPE* __restrict__ b, volatile VALUE_TYPE* x, volatile int* is_solved, int n);
template __global__  void csr_L_solve_simple_kernel_coop<16>(int* row_ctr, const int* __restrict__ row_ptr, const int* __restrict__ col_idx, const VALUE_TYPE* __restrict__ val, const VALUE_TYPE* __restrict__ b, volatile VALUE_TYPE* x, volatile int* is_solved, int n);
template __global__  void csr_L_solve_simple_kernel_coop<32>(int* row_ctr, const int* __restrict__ row_ptr, const int* __restrict__ col_idx, const VALUE_TYPE* __restrict__ val, const VALUE_TYPE* __restrict__ b, volatile VALUE_TYPE* x, volatile int* is_solved, int n);
